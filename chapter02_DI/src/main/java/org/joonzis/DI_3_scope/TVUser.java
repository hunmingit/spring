...
public class TVUser {
	public static void main(String[] args) {
		...
		System.out.println(ltv == ltv2 ? "같은 객체" : "다른 객체"); //prototype은 매 번 호출 할 때마다 객체를 생성 하기 때문에 다른 객체
		System.out.println(stv == stv2 ? "같은 객체" : "다른 객체"); //삼성은 싱글톤이라 한 번 생성해두고 호출 할 때 마다 같은 걸 호출함 그래서 같은 객체
